...
public class Student {
    ...
    private double progressionRequirenemt;

    // constructor
    public Student(String name, String surname, String gender, String nationality, String programme, String course, String pathway, double progressionRequirenemt) {
        this.firstName = name;
        ...
        this.progressionRequirenemt = progressionRequirenemt;
    }
    ...
    public double getProgressionRequirenemt() {
        return progressionRequirenemt;
    }
    ...
    public void setProgressionRequirenemt(double progressionRequirenemt) {
        this.progressionRequirenemt = progressionRequirenemt;
    }
}
